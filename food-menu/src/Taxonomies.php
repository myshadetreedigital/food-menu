...
/**
 * Registers the Branch, Location, and Category taxonomies for Food Menu Items.
 */
class Taxonomies {
	...
	public function register() {
		...
		$this->register_taxonomy(
			...
			__( 'The menu section this item appears under, e.g. Brunch, Lunch, Specials.', 'food-menu' )
		);
	}
