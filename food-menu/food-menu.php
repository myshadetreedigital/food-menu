 ...
 * Description:        Structured food menu data (branches, locations, categories, prices, variations) built for Elementor Loop Grid/Carousel presentation. Core data model — addons (POS sync, etc.) attach to it.
 * Version:            2.0.0
...
define( 'FOOD_MENU_VERSION', '2.0.0' );
